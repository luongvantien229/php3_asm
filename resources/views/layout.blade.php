    ...
    <div class="container mt-3">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="/contact" class="nav-link px-2 text-dark">Liên lạc</a></li>
                <li><a href="/about" class="nav-link px-2 text-dark">Thông tin</a></li>
                <li><a href="/cart" class="nav-link px-2 text-dark">Giỏ hàng</a></li>
            </ul>

            <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                <input id="searchInput" type="search" class="form-control form-control-dark" placeholder="Tìm kiếm..." aria-label="Search" />
            </form>
